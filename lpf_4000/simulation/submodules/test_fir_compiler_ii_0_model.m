...
% ================================================================================
% Generated on: 04/09/2023 14:10:13
...
for j = 1:sx
    ...
    %
    file_name = ['test_fir_compiler_ii_0_input.txt'];
     ...
     % run this output through the model 
      for i =  1 : num_ch
        if(not(isempty(single_channel_data{i})))
          output_ch{i} = test_fir_compiler_ii_0_mlab(single_channel_data{i}, single_channel_bank{i});
  ...
  for j = 1: limit;
    ...
    file_name = ['test_fir_compiler_ii_0_model_output'];
