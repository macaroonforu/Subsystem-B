...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/hilbert_fir_compiler_ii_0_rtl_core_u0_m0_wo0_cm0_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/submodules/hilbert_fir_compiler_ii_0_rtl_core_u0_m0_wo0_wi0_r0_ra0_count1_lut_lutmem.hex ./
}
...
alias com {
  ...
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/hilbert_fir_compiler_ii_0_rtl_core.vhd"          -work fir_compiler_ii_0
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/hilbert_fir_compiler_ii_0_ast.vhd"               -work fir_compiler_ii_0
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/hilbert_fir_compiler_ii_0.vhd"                   -work fir_compiler_ii_0
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/hilbert_fir_compiler_ii_0_tb.vhd"                -work fir_compiler_ii_0
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/hilbert.v"                                                                         
}
