...
# ACDS 18.1 625 win32 2023.04.09.14:12:35
...
# ----------------------------------------
# If hilbert is one of several IP cores in your
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/hilbert_fir_compiler_ii_0_rtl_core_u0_m0_wo0_cm0_lutmem.hex ./
  cp -f $QSYS_SIMDIR/submodules/hilbert_fir_compiler_ii_0_rtl_core_u0_m0_wo0_wi0_r0_ra0_count1_lut_lutmem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/hilbert_fir_compiler_ii_0_rtl_core.vhd"          -work fir_compiler_ii_0 -cdslib ./cds_libs/fir_compiler_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/hilbert_fir_compiler_ii_0_ast.vhd"               -work fir_compiler_ii_0 -cdslib ./cds_libs/fir_compiler_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/hilbert_fir_compiler_ii_0.vhd"                   -work fir_compiler_ii_0 -cdslib ./cds_libs/fir_compiler_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/hilbert_fir_compiler_ii_0_tb.vhd"                -work fir_compiler_ii_0 -cdslib ./cds_libs/fir_compiler_ii_0.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/hilbert.v"                                                                                                                      
fi
